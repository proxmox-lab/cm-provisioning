...
export GITHUB_REPOSITORY=proxmox-lab/cm-provisioning
...
export TF_VAR_CONFIG_GIT_HOST=github.com
export TF_VAR_CONFIG_GIT_REPOSITORY_URL=git@github.com:proxmox-lab/cm-configuration-private.git
export TF_VAR_DEFAULT_GATEWAY=
export TF_VAR_FS_SPEC=
export TF_VAR_GIT_REPOSITORY=$GITHUB_REPOSITORY
export TF_VAR_GIT_SHORT_SHA=${GITHUB_SHA:~8}
export TF_VAR_IP_ADDRESS=
export TF_VAR_NETMASK=
export TF_VAR_PRIVATE_GPG_KEY=
export TF_VAR_PRIVATE_KEY=
export TF_VAR_PUBLIC_GPG_KEY=
